...
enum WorldBoolConfigs
{
    ...
    CONFIG_REBIRTH_VOTESYSTEM_ENABLED,
    CONFIG_REBIRTH_VOTESYSTEM_REWARDS_ENABLED,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_TEAMONE_TELEPORT_X,  //TeamOne
    CONFIG_TEAMONE_TELEPORT_Y,
    CONFIG_TEAMONE_TELEPORT_Z,
    CONFIG_TEAMONE_TELEPORT_O,
    CONFIG_TEAMTWO_TELEPORT_X,  //TeamTwo
    CONFIG_TEAMTWO_TELEPORT_Y,
    CONFIG_TEAMTWO_TELEPORT_Z,
    CONFIG_TEAMTWO_TELEPORT_O,
    CONFIG_TEAMWIPE_TELEPORT_X,  //TeamWipe
    CONFIG_TEAMWIPE_TELEPORT_Y,
    CONFIG_TEAMWIPE_TELEPORT_Z,
    CONFIG_TEAMWIPE_TELEPORT_O,
...
enum WorldIntConfigs
{
    ...
    CONFIG_TEAMONE_TELEPORT_MAP,
    CONFIG_TEAMTWO_TELEPORT_MAP,
    CONFIG_TEAMWIPE_TELEPORT_MAP,
